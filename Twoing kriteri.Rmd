...
# Veri setleri ve benchmark işlemleri için doğru paket adı
...
```{r}
# Parametreleri ayarlayarak modeli tekrar oluşturalım
...
# Örnek: Tablo 6.3’de verilen golf verisi için twoing kriterini kullanarak CART algoritmasına dayalı karar ağacını oluşturalım.
...
P_L <- 5 / 14  # Havanın güneşli olma olasılığı
P_R <- 9 / 14  # Havanın bulutlu veya yağmurlu olma olasılığı
